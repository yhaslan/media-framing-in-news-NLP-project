...
Taking into account all these controversies and the powerful impacts of media framing found in the previous literature, this study aims to portray from a distance how the current events are conveyed from different perspectives through language usage in media news.
